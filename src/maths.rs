...
/// a function that describle the angular distribution of the velocity generated by the oven
/// it is not clear to me if the result is applicable to all ovens
