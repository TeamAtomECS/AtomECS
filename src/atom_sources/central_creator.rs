...
pub struct CentralCreator {
    position_density_distribution: Position_Density_Distribution,
    velocity_density_distribution: Velocity_Density_Distribution,
    spatial_velocity_distribution: Spatial_Velocity_Distribution,
}

impl CentralCreator {
    pub fn new_uniform_sphere() -> Self {
        Self {
            position_density_distribution: Position_Density_Distribution::Uniform_Spheric {
                radius: 5.0e-6,
            },
            velocity_density_distribution: Velocity_Density_Distribution::Uniform_Spheric {
                radius: 5.0e-6,
            },
            spatial_velocity_distribution: Spatial_Velocity_Distribution::Uniform {
                min_vel: 0.1,
                max_vel: 2.0,
            },
        }
